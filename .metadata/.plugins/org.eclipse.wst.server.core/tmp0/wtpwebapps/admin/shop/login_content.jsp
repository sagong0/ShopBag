 ...
 <div class="products">
      ...
      <div class="sub_view">
        ...
        <div class="loginview">
          ...
          <tr>
          <td>
          <input type="text" name="uid" placeholder="아이디를 입력해주세요" class="id">
          </td>
          <td rowspan="2">
          ...
          <tr>
          <td>
          <input type="password" name="upw" placeholder="패스워드를 입력해주세요" class="id">
          </td>
          </tr>
          </table>
          ...
          <ul class="btns_login">
	          <li><a class="a" href="./agree.do">회원가입</a></li>
    ...
    <script src="./js/login_content.js?v=<%=lc_sf.format(lc_day)%>"></script>
